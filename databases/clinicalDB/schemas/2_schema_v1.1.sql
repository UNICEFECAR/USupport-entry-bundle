...
ALTER TYPE "notification_type" ADD VALUE 'consultation_booking';
...
ALTER TYPE "notification_type" RENAME VALUE 'consultation_suggestion_rejection' TO 'consultation_suggestion_cancellation';
