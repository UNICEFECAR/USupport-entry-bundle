...
<figure><img src="../.gitbook/assets/image.png" alt=""><figcaption><p>Figure 24: Campaigns screen</p></figcaption></figure>
...
<figure><img src="../.gitbook/assets/image (1).png" alt=""><figcaption><p>Figure 25: Enroll to a new campaign</p></figcaption></figure>

<figure><img src="../.gitbook/assets/image (3).png" alt=""><figcaption><p>Figure 26: Campaign Terms of Use</p></figcaption></figure>
...
### 8. Campaigns availability <a href="#ole_link90" id="ole_link90"></a>
...
<figure><img src="../.gitbook/assets/image (4).png" alt=""><figcaption><p>Figure 27: Add availability for campaign</p></figcaption></figure>

<figure><img src="../.gitbook/assets/image (5).png" alt=""><figcaption><p>Figure 28: Availability campaign for campaigns</p></figcaption></figure>
...
### 9. View campaigns details <a href="#ole_link12" id="ole_link12"></a>
...
<figure><img src="../.gitbook/assets/image (6).png" alt=""><figcaption><p>Figure 29: Visualize campaign activity</p></figcaption></figure>
...
<figure><img src="../.gitbook/assets/image (7).png" alt=""><figcaption><p>Figure 30: My Q&#x26;A screen</p></figcaption></figure>

On this screen, providers can access the necessary tools to respond to questions raised by clients. As shown in Figure 30, the questions are divided into three categories: unanswered, answered, and answered by the provider. Providers can select a category to view relevant questions.

Within the "Unanswered" tab, providers can read client questions and choose which ones to answer. To respond to a question, providers need to click the "Respond" button in the left corner of the question. Figure 31 displays the view that allows providers to provide their answers.
...
The responses provided by the providers include a title, answer, and multiple tags. Providers have the option to choose from a predefined list of tags or create new ones by typing in a desired name. Figure 33 demonstrates how tags can be added and removed effortlessly.

<figure><img src="../.gitbook/assets/image (10).png" alt=""><figcaption><p>Figure 33: My Q&#x26;A answer tags</p></figcaption></figure>
...
In addition, providers have the option to view questions that were previously answered by other providers and provide their own response. To do so, providers can select the "Answered" tab, as shown in Figure 34. This feature allows for collaboration between providers and ensures that clients receive the most accurate and helpful answers to their inquiries.

<figure><img src="../.gitbook/assets/image (396).png" alt=""><figcaption><p>Figure 34: My Q&#x26;A add new answer</p></figcaption></figure>
