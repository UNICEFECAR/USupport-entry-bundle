...
docker-compose -f docker-compose-local.yml up -d --build client
docker-compose -f docker-compose-local.yml up -d --build user
docker-compose -f docker-compose-local.yml up -d --build messaging
docker-compose -f docker-compose-local.yml up -d --build notifications
docker-compose -f docker-compose-local.yml up -d --build payments
docker-compose -f docker-compose-local.yml up -d --build provider
docker-compose -f docker-compose-local.yml up -d --build video
docker-compose -f docker-compose-local.yml up -d --build email
